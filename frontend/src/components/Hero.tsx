      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mx-auto max-w-4xl animate-fade-in-up">
          ...
          <p className="mx-auto max-w-2xl text-lg text-zinc-400 mb-10 leading-relaxed">
            The first fully integrated copy trading experience. No dashboards, no delays — Nord empowers you to trade directly alongside the best.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="h-14 px-8 text-lg min-w-[160px]">
              Get Started
            </Button>
            <Button size="lg" variant="secondary" className="h-14 px-8 text-lg min-w-[160px]">
              Learn More
            </Button>
          </div>
        </div>
                    ...
                    <div className="col-span-12 md:col-span-7 space-y-6">
                         ...
                         <div className="h-64 bg-white/5 rounded-xl border border-white/5 relative overflow-hidden">
                             ...
                             <svg className="absolute bottom-0 w-full h-full text-primary" fill="none" viewBox="0 0 100 50" preserveAspectRatio="none">
                                ...
                                <path d="M0,50 L10,45 L20,30 L30,35 L40,20 L50,25 L60,10 L70,15 L80,5 L90,10 L100,0 V50 Z" fill="url(#chartGradient)" />
                                <path d="M0,50 L10,45 L20,30 L30,35 L40,20 L50,25 L60,10 L70,15 L80,5 L90,10 L100,0" stroke="currentColor" strokeWidth="0.5" />
                             </svg>
                         </div>
                    </div>
                     {/* Right Panel */}
