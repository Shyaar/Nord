      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto">
            Whether you're starting out or already a pro, we've built the
            perfect ecosystem for you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {/* For Copiers */}
          <Card
            className="bg-[#0A0A0A] border-white/5 p-8 md:p-12 relative overflow-hidden group"
            hover
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold text-white mb-8">
                Start Earning{" "}
                <span className="text-zinc-500">Without Trading</span>
              </h3>
